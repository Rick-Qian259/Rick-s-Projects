...
public class DistanceVector {
    public static void main(String[] args) {
        ...
        DistanceVector dis = new DistanceVector();
        DistanceVector.Change change = dis.new Change(true);
        DistanceVector.Change hasThirdPart = dis.new Change(false);

        DistanceVector.Process process = dis.new Process();

        String path = "src/input2";
...
//        return topologyUpdates;
        ...
        public void readFiles(DistanceVector.Change hasThirdPart) {
